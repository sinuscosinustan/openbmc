...
AMPERE_POWER_ON = "obmc-power-already-on@{0}.target"
POWER_ON_DRIVER_BINDER_TARGET_FMT = "../${POWER_ON_DRIVER_BINDER_TGT}:${AMPERE_POWER_ON}.wants/${POWER_ON_DRIVER_BINDER_INSTMPL}"
...
HOST_ON_DRIVER_BINDER_TARGET_FMT = "../${HOST_ON_DRIVER_BINDER_TGT}:${AMPERE_HOST_RUNNING}.wants/${HOST_ON_DRIVER_BINDER_INSTMPL}"
